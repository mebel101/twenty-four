...
<div class="form-outline form-dark mb-4 mt-3">
...
<div class="g-recaptcha" data-sitekey="6LcKNJ8kAAAAAIVxaLRD-5qTn0mzgB2ajAZxi966"></div>
<p></p>
<button class="btn btn-outline-dark px-5" id="submit_login" type="button">เข้าสู่ระบบ</button>
...
<div>
<p class="mb-0">ยังไม่มีบัญชี? <a href="/register" class="text-dark fw-bold">สมัครสมาชิก</a>
</p>
</div>
</div>
</div>
